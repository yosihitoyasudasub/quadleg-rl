...
- l1 を小さくするとトルクは下がるが、同じ足先移動により大きなクランク回転が必要になる。
  l1=30 は「トルク 53%・クランク角幅 105°」のバランス点。l1=35/l2=60 なら 59%・94°
...
`{"d0":30,"l1":25,"l2":70,"fx":0,"fy":-67,"mass":1.0,"legs":2,"sf":1.5,"fxr":0,"servo":0,"stall":4.0,"sW":24,"sH":36,"sOff":9,"sA":90,"oy":0,"oz":0,"t3":0,"bodyW":110,"bodyL":140}`
