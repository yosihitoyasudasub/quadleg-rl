...
- 0.7 kg・脚長 73 mm・動的係数 1.5 での外転トルク

  | 外転角 φ | 水平距離 d | 4 脚支持 | 2 脚支持 | スタンス幅 |
  | --- | --- | --- | --- | --- |
  | 0° | 0 mm | 0 N·m | 0 N·m | 胴体幅と同じ |
  | 10° | 12.7 mm | 0.033 | 0.065 | +25 mm |
  | 20° | 25.0 mm | 0.064 | 0.129 | +50 mm |
  | 30° | 36.5 mm | 0.094 | 0.188 | +73 mm |

  連続定格 0.13 N·m を基準にすると、**2 脚支持で常用できるのは φ ≈ 20° まで**
