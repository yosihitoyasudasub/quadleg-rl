...
| 部品 | 仕様 | 備考 |
| --- | --- | --- |
| 足先ブロック | F の二股（§5-1）＋**腕**（幅 8 × 厚 2.5、F から上へ **60 mm**、**スロット 幅 3 × 全長 18**：丸端の中心を F から **40 mm と 55 mm** に）＋ガイド管、を 1 部品 | 腕は片方の耳（z +4.75〜7.25）をそのまま上へ延ばす |
...
| ゴムパッド | 3.0 g |
| ピン・軸受類 | 5.0 g |
| 菱形リンク（小リンク 1.54 × 2 ＋ ピン 3 本 2.74 ＋ スペーサ 0.18 ＋ E リング 0.1） | 6.1 g |
| 足先ブロックの腕（60 × 8 × t2.5、スロット付き） | 1.3 g |
| **合計** | **60.6 g** |

50 g を 10.6 g 超える。削るならシャンク（PA-CF 中空の肉厚 1.0 → 0.8）か足先ブロックの肉抜き。
