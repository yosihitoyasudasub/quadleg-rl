...
> **2026-09-13 注記**: ばね定数を 1500 N/m にした採用案では中立の先端長が 145 → **134 mm** になる（§7-1）。
> このとき クランク① −148.4° / ② −31.6°、後ろ振り 40 mm で **クランク① −168.9°**（現行 −162.6° より 6° 深い）。
> 上の表は 3D 確認後に差し替えること。なお **先端長 114 mm 以下は不可**
> （後ろ振りでクランク① が +178° まで回り、水平を越えて相手側サーボ本体と干渉する）。
...
### 7-6. 調達（2026-09-13 調査）

**結論: 標準品では一致しない。特注（1 個から作るメーカーに図面を出す）が現実解。**
