...
| **小リンク × 2** | ピン間 **30 ±0.05 mm**、幅 8（両端 R4）、A2017 **t2**、φ3 H7 × 2 | 各シャンクの外面側の層。二力部材（軸力 140 N → 引張 14 MPa、面圧 23 MPa）。**1.54 g × 2** |
| ピン A1・A2 | φ3 × 12 段付ボルト。シャンクの F から 30 mm の穴（§5-2） | 左右ともスペーサ 3.25（リンクを層の位置に保つため） |
...
| ゴムパッド | 3.0 g |
| ピン・軸受類 | 5.0 g |
| 菱形リンク（小リンク 1.54×2 ＋ ピン C 1.23 ＋ ピン A 0.67×2 ＋ スペーサ 0.18×2 ＋ E リング 0.1） | 6.1 g |
| 足先ブロックの腕 × 2（60 × 8 × t2.5、スロット付き） | 2.6 g |
| **合計** | **61.9 g** |

50 g を 11.9 g 超える。削るならシャンク（PA-CF 中空の肉厚 1.0 → 0.8）か足先ブロックの肉抜き。
